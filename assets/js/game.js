...
var endGame = function() {
  ...
  //if player has more money than the high score, plyaer has a new high score
  if (playerInfo.money > highScore) {
    ...
    alert(playerInfo.name + " did not beat the high socre of " + highScore + ". Maybe next time!");
  }
